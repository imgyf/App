    ...
    workspace: {
        common: {
            ...
            outstandingBalanceWarning:
                'Você tem um saldo pendente que deve ser quitado antes de excluir seu último workspace. Acesse as configurações de assinatura para resolver o pagamento.',
            settleBalance: 'Ir para assinatura',
