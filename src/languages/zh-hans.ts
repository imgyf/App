...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    homePage: {
        ...
        timeSensitiveSection: {
            ...
            reviewCardFraud: {
                title: '审核您 Expensify Card 上的潜在欺诈交易',
...
${
    ...
    workspace: {
        common: {
            ...
            outstandingBalanceWarning: '您有未结清的余额，必须在删除最后一个工作区之前结清。请前往订阅设置解决付款问题。',
            settleBalance: '前往订阅',
            unavailable: '工作区不可用',
...
3. 订阅源启用后，点击下方的“提交”，我们会开始为你添加它。`,
        ...
        expensifyCard: {
            ...
            issuedCardVirtual: (assignee: string, link: string) => `已为 ${assignee} 发放一张虚拟 Expensify 卡！${link} 可立即使用。`,
