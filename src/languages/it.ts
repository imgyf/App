    ...
    workspace: {
        common: {
            ...
            outstandingBalanceWarning:
                'Hai un saldo in sospeso che deve essere saldato prima di eliminare il tuo ultimo spazio di lavoro. Vai alle impostazioni del tuo abbonamento per risolvere il pagamento.',
...
3. Una volta che il feed è abilitato, fai clic su Invia qui sotto e noi ci occuperemo di aggiungerlo.`,
        ...
        expensifyCard: {
            ...
            issuedCardVirtual: (assignee: string, link: string) => `ha emesso a ${assignee} una carta virtuale Expensify! Il/la ${link} può essere usato/a subito.`,
            ...
            replacedVirtualCard: (assignee: string, link: string) => `${assignee} ha sostituito la sua Expensify Card virtuale! La ${link} può essere usata subito.`,
            card: 'carta',
